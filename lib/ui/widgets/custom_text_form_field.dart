...
import 'package:smol_crudclient_felipe/ui/styles/custom_border_painter.dart';
...
import 'package:smol_crudclient_felipe/ui/styles/size_provider_widget.dart';
        ...
        if (hasError) ...[
          ...
          if (widget.errorMessage != null)
            Container(
              ...
              child: Text(
                widget.errorMessage!,
              ).regularMedium(const Color(0xFFF3BEBE)),
            ),
        ],
      ],
    );
